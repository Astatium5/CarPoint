...
class Requests:
    ...
    def get_all_fuel_types(self, mark: str, body: str, min_price: int, max_price: int) -> dict:
        path: str = r"api/get_all_fuel_types/"
        response: dict = make_request(
    ...
    def get_car_info(self, id: int) -> dict:
        path: str = r"api/get_car_info/"
        response: dict = make_request(path=path, id=id)
        return response

    def create_entry(self, user_id: int, username: str, car_id: int, email: str,
                     name: str, address: str, phone: str) -> dict:
        path: str = r"api/create_entry/"
